  ...
  const services = [
    {
      ...
      description: "Frota moderna e adequada para diferentes tipos de produtos químicos"
    },
    {
      icon: <ShieldCheck className="w-12 h-12 text-yellow-500" />,
      title: "Segurança Certificada",
      description: "Cumprimento rigoroso das normas de segurança e regulamentações"
    },
    {
      icon: <Clock className="w-12 h-12 text-yellow-500" />,
      title: "Pontualidade",
      description: "Compromisso com prazos e planejamento logístico eficiente"
    },
    {
